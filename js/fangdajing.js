function ShowGoods(json){
	...
	if(typeof this.initUI!="function"){
		ShowGoods.prototype.initUI=function(){
			...
			str+="<div class='fangdajing' style='width:"+this.imgWidth+"px;height:"+this.imgHeight+"px;display:none;position:absolute;top:0;left:"+this.boxWidth+"px;overflow:hidden'><img src="+this.imgArr[0]+" style='position:absolute;z-index:999;width:"+this.imgWidth*this.times+"px;height:"+this.imgHeight*this.times+"px'/></div>";
			...
			for(var i=0;i<this.imgArr.length;++i){
				str+="<li style='box-sizing:border-box;border:2px solid"+ this.listBorderColor+";width:"+this.listWidth+"px;height:"+this.listHeight+"px;margin-right:"+this.listSpace+"px;list-style:none;float:left;'><img id='imgId' src="+this.imgArr[i]+" style='width:100%;height:100%' /></li>"
			}
			str+="</ul>";
